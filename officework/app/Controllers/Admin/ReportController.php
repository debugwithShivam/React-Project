...
{
    public function __construct(private readonly string $moduleKey = 'mart', private readonly string $label = 'Mart')
    {
    }
    ...
    public function index(): void
    {
        ...
        View::render('admin/reports', [
            ...
            'exportBase' => $this->moduleKey === 'ecommerce' ? '/admin/ecommerce/reports/export' : '/admin/reports/export',
        ]);
    }
